 ...
 * @property {() => Promise<Invitation>} makeReturnAttInvitation Make an
 *   invitation for returning an attestation.
 */
 ...
 * @property {bigint} currentTime Performance note: getAccountState is
 *   expensive, as it has to iterate over all delegations.
 *
